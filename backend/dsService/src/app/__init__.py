...
@app.route('/v1/ds/message', methods=['POST']) #Endpoint: http://localhost:8010/v1/ds/message
def handle_message():
...
@app.route('/v1/ds/ping', methods=['GET']) #Endpoint: http://localhost:8010/v1/ds/ping
def handle_get():
    return 'Pong'